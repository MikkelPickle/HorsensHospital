...
export default function IntensiveDisplay() {
  return (
    <ParallaxScrollView
      headerBackgroundColor={{ light: '#D0D0D0', dark: '#353636' }}
      headerImage={
        <Image
          source={require('@/assets/images/Intensive.png')}  // Replace with your actual image path
    ...
    >
      <ThemedView style={styles.titleContainer}>
        <ThemedText type="title">Intensiv Afdeling</ThemedText>
      </ThemedView>
      <ThemedText>Dette er intensiv afdeling.</ThemedText>
    </ParallaxScrollView>
  );
}
